...
interface ProjectListItemRightProps {
  value: any
  handleImageClick: (project: any) => void
}

const ProjectListItemRight: React.FC<ProjectListItemRightProps> = ({
  value,
  handleImageClick,
}) => (
  <div className="flex md:contents flex-row-reverse" key={value.id}>
    <div className="relative my-6 text-gray-800 rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto flex justify-center items-center">
...
export default ProjectListItemRight
