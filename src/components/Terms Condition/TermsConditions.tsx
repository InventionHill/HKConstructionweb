...
const TermsAndConditions = () => {
  ...
  return (
    <div className="max-w-screen-lg mx-auto p-5">
      <h2 className="text-3xl mt-8 mb-4">Terms and Conditions</h2>
      <p className="mb-4">Last updated: June 06, 2024</p>

      <h3 className="text-2xl mt-8 mb-4">
        Interpretation and Definitions
      </h3>
      <h4 className="text-xl mt-6 mb-2">Interpretation</h4>
      <p className="mb-4">
      ...
      <h4 className="text-xl mt-6 mb-2">Definitions</h4>
      ...
      <ul className="list-disc ml-8">
        ...
        <li className="mb-4">
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to HK Construction, Rajkot.
        </li>
        <li className="mb-4">
        ...
        <li className="mb-4">
          <strong>Website:</strong> refers to HK Constructions, accessible from{' '}
          <a href="https://hk-construction.inventionhill.com/">
            https://hk-construction.inventionhill.com/
          </a>
        </li>
        <li className="mb-4">
      ...
      <h3 className="text-2xl mt-8 mb-4">Acknowledgment</h3>
      <p className="mb-4">
      ...
      <h3 className="text-2xl mt-8 mb-4">Governing Law</h3>
      <p className="mb-4">
      ...
      <h2 className="text-3xl mt-8 mb-4">Severability and Waiver</h2>
      <h3 className="text-2xl mt-8 mb-4">Severability</h3>
      <p className="mb-4">
      ...
      <h3 className="text-2xl mt-8 mb-4">Waiver</h3>
      <p className="mb-4">
      ...
      <h2 className="text-3xl mt-8 mb-4">Translation Interpretation</h2>
      <p className="mb-4">
      ...
      <h2 className="text-3xl mt-8 mb-4">Contact Us</h2>
      <div className="mt-8">
        <p className="mb-4">
